...
import { FaLeaf, FaCamera, FaChartBar } from "react-icons/fa";
    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <div className="flex flex-grow flex-col justify-center items-center text-center px-6">
        ...
        <p className="text-lg text-gray-600 mt-3 max-w-2xl">
          Upload an image of a potato leaf or poultry feces, and our AI-powered system will detect potential diseases with high accuracy.
        </p>
        <Link to="/potato-detection">
      ...
      {/* Features Section */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-10 max-w-5xl mx-auto pb-10">
